(() => {
  ...
  function apply(changed) {
    ...
    $('browser-mode').textContent=settings.useProxy?'Custom proxy':'Direct preview';
  ...
  function route(){
    ...
    if(next==='browser'&&currentRoute!==next&&historyIndex>=0)renderAddress(history[historyIndex]);
